 ...
 * @author Phong Linh
 */
public class PositionCtrl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(mode) {
            case "0": //create
                ...
                control.createPosi(Name);
                break;
            case "1": //edit
                id = Integer.parseInt(id_String);
                String newName = request.getParameter("name");
                if (!isNullOrEmpty(newName)) {
                    control.editPosition(id, newName);
                }
                break;
            case "2": //delete
                int replaceId = -1;
                ...
                control.deletePosi(id, replaceId);
                break;
            default:
                break;
        }
        response.sendRedirect("control?tab=3");
    }
